...
3. Enable user (procurement manager) to generate a Quotation. _[Done]_
4. Enable user (procurement manager) to generate an Order. _[Done]_
5. Enable user (sales manager) to generate a Tax Invoice. _[In-progress]_